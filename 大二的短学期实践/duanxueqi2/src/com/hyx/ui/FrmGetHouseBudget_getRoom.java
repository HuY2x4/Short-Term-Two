...
public class FrmGetHouseBudget_getRoom extends JDialog implements ActionListener{
...
//	private JTable table = new JTable(model);;
	...
	public FrmGetHouseBudget_getRoom (FrmUpdHouse frmUpdHouse, String s, boolean b,int houseId) throws BaseException {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.btnCancel){
			...
			if(selectRows==1){ 
			    ...
			    this.setVisible(false);
			    try {
			    	FrmGetHouseBudget_mainRoom f=new FrmGetHouseBudget_mainRoom(null,"房间信息",true,data);
