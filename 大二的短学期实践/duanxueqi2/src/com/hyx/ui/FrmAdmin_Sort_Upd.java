...
public class FrmAdmin_Sort_Upd extends JDialog implements ActionListener {
	...
	public FrmAdmin_Sort_Upd(Dialog f, String s, boolean b,String data) {
		super(f, s, b);
		data1=data;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			startUtil.sortContr.updSort(data1, remark);
			this.setVisible(false);
