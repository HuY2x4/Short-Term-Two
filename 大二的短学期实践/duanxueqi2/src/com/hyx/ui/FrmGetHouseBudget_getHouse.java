...
public class FrmGetHouseBudget_getHouse extends JDialog implements ActionListener{
    ...
    String[] titles = { "客户ID","客户名","房子ID", "地址","面积","房间数量","客厅数量","厨房数量","厕所数量" };
	//private DefaultTableModel model = new DefaultTableModel(datas, titles);;
//	private JTable table = new JTable(model);;
	//private JScrollPane scroll = new JScrollPane(table);
	public FrmGetHouseBudget_getHouse (Frame f, String s, boolean b) throws BaseException {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnSousuo) {
			...
			if(selectRows==1){ 
			    ...
			    int data=(int)model.getValueAt(selectedRowIndex, 2);
			    this.setVisible(false);
			    try {
			    	FrmGetHouseBudget_main getbudget=new FrmGetHouseBudget_main(null,"预算信息",true,data);
				} catch (BaseException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
